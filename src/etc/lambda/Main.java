...
import static etc.lambda.FilterApple.filterAppleByColor;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("========== 빨강 또는 노랑 사과 필터링 ==========");
        // 빨강 또는 노랑 사과만 필터링
        // 익명 클래스 (anonymous class)
        // new 인터페이스타입() 문법으로 즉석에서 선언하여 사용하는 클래스.
        // 선언부에 추상메서드 오버라이팅을 즉시 선언하여 사용합니다.
        ...
        // 조건 -> 인터페이스의 추상메서드가 단 하나일 경우에만 가능합니다.
        ...
        // 게다가 메서드 내부에는 return 한줄만 쓸거라서 괄호랑 return을 생략해 버리니까 이런 모앵이 나오더라.
        ...
        // 사과 색깔이 빨강 혹은 초록 이면서 무게가 150g 미만이어야 한다.
        ...
        System.out.println("========== 숫자들에서 제곱수를 맵핑 ==========");
