...
public class Finding {
    ...
    public static void main(String[] args) {
        ...
        // 음식 메뉴중에 칼로리가 500 이상이면서 채식주의자가 먹을 수 있는 음식이 있는가? (네/ 아니오)
        ...
        // 음식 메뉴중에 모든 요리가 100칼로리 미만이 아닌가요?
