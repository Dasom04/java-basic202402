...
public class 람다스트림정리 {
    ...
    public static List<String> getHealthyDishName(List<Dish> menu) {
         /*
            요리 목록(menuList)에서 칼로리가 400칼로리보다 작은 요리들만 추출해서
        ...
        // 칼로리를 낮은 순으로 오름차 정렬.
        lowCaloriDishes.sort(new Comparator<Dish>() {
            @Override
    ...
    public static List<String> getHealthyDishName2(List<Dish> menu) {
        return menu.stream()
                ...
                .collect(Collectors.toList()); // 리트스로 포장.
    }
    ...
    public static void main(String[] args) {
        ...
        final List<String> dishName1 = getHealthyDishName(Menu.menuList);
        System.out.println("dishName1 = " + dishName1);

        final List<String> dishName2 = getHealthyDishName2(Menu.menuList);
