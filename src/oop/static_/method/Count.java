...
public class Count {
    ...
    /*
    # 인스턴스 메서드: 객체를 통해 생성하여 주소값을 통해 접근한 후 호출하는 메서드
...
/*
     - static 블록(메서드, 저적 초기화자) 내부에서는
       static이 붙은 변수나 메서드만 사용할 수 있습니다.

     -  this는 사용할 수 없습니다. -> 나타낼 주소값이 없기 때문 -> 객체 생성없이도 호출이 가능하기 때문.

     - static 블록 내부에 non-static 멤버를 참조하려면
