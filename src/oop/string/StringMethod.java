...
public class StringMethod {
    public static void main(String[] args) {
        ...
        // subString(begin, end): 문자열을 범위를 지정해서 부분 추출.  end-> 미만
        String ss1 = str.substring(1, 5);  // 1번 이상 5번 미만.
        System.out.println("ss1= "+ ss1);

        String ss2 = str.substring(6);  // end를 안주면 6번부터 끝까지 나온다.
        ...
        System.out.println("l2 = " + idx2);

        // 여러 문자를 전달하면 시작하면 인덱스를 알려줍니다.
        ...
        int i = Integer.parseInt(s1);  // 문자열 -> 정수 (실수 넣으면 에러뜬다.)
