...
public class OderService implements AppService {
    ...
    private void rentalProcess(int movieNumber) {
        ...
        if (users.size() > 0) {
            ...
            if(userNums.contains(userNumber)) {
                ...
                rentalMovie.setRental(true); // 대여 상태를 대여중으로 변경.
                rentalMovie.setRentalUser(rentalUser); // 영화 객체에 렌탈 유지 등록
